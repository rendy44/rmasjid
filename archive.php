...
<div class="row">
	<div class="col-xl-9 col-lg-10 col-md-11 mx-auto text-muted text-center">
		<?php the_archive_description( '<div class="mb-5">', '</div>' ); ?>
	</div>
</div>
<div class="row">
		...
		if ( have_posts() ) {
			...
			<div class="row">
				...
				while ( have_posts() ) {
					...
					echo $post_result; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				}
				?>
			</div>
			<?php
