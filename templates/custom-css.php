...
$solid_color          = MaHelper::get_solid_main_color();
$solid_color_rgb      = MaHelper::hex2rgb( $solid_color );
$background_image_url = MaHelper::get_default_background_image_url()
?>
...
<style type="text/css">
    ...
    .btn-primary:hover, .btn-primary:active, .btn-primary:focus, .btn-primary:not(:disabled):not(.disabled):active, .btn-primary:not(:disabled):not(.disabled):focus {
        background-color: <?php echo MaHelper::darken_color($solid_color,1.2); ?>;
        border-color: <?php echo MaHelper::darken_color($solid_color,1.2); ?>;
    }
    ...
    .bg-primary {
        background-color: <?php echo MaHelper::darken_color($solid_color,2); ?> !important;
    }
    ...
    footer.bg-primary .network {
        background-color: <?php echo MaHelper::darken_color($solid_color,1.8); ?> !important;
    }
</style>
