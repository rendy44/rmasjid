...
while ( have_posts() ) {
				...
				foreach ( $sliders as $slider ) {
                    ...
                    <div class="carousel-item <?php echo $active_slider; // phpcs:ignore ?>">
                        ...
                        <div class="carousel-item-wrapper d-flex" <?php echo $background_inline; // phpcs:ignore ?>>
                            <div class="container">
								<?php
								$slider_item = $temp->render( 'front-masthead', [
    ...
    <section class="bg-white" id="campaign">
        <div class="container">
			...
			$campaign_result   = $temp->render( 'front-campaign', [
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
					...
					<?php
					$campaign_result = $temp->render( 'progress-bar', [
						'height' => 25,
	...
	if ( ! empty( $lecture_items ) ) {
        ...
        <section class="bg-light" id="front_latest_lecture">
            <div class="container">
				...
				$lecture_result   = $temp->render( 'front-latest-lecture', [
					'title'    => $lecture_title,
	...
	if ( ! empty( $article_items ) ) {
        ...
        <section class="bg-white" id="front_latest_article">
            <div class="container">
				...
				$article_result   = $temp->render( 'front-latest-article', [
					'title'    => $article_title,
	...
	if ( ( $now_date === $salat_date ) && ! empty( $salat ) ) {
        ...
        <section class="bg-city">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center">
                        <p class="lead mb-4"><?php echo __( 'Today prayer times in', 'masjid' ) . ' ' . $salat_city . ', ' . $salat_country; ?></p>
                        <div class="row">
                            <div class="col-6 col-sm-2">
                                <span><?php echo __( 'Fajr', 'masjid' ); ?></span>
                                <strong><?php echo $salat['fajr']; ?></strong>
                            </div>
                            <div class="col-6 col-sm-2">
                                <span><?php echo __( 'Shurooq', 'masjid' ); ?></span>
                                <strong><?php echo $salat['shurooq']; ?></strong>
                            </div>
                            <div class="col-6 col-sm-2">
                                <span><?php echo __( 'Dhuhr', 'masjid' ); ?></span>
                                <strong><?php echo $salat['dhuhr']; ?></strong>
                            </div>
                            <div class="col-6 col-sm-2">
                                <span><?php echo __( 'Ashr', 'masjid' ); ?></span>
                                <strong><?php echo $salat['asr']; ?></strong>
                            </div>
                            <div class="col-6 col-sm-2">
                                <span><?php echo __( 'Maghrib', 'masjid' ); ?></span>
                                <strong><?php echo $salat['maghrib']; ?></strong>
                            </div>
                            <div class="col-6 col-sm-2">
                                <span><?php echo __( 'Isha', 'masjid' ); ?></span>
                                <strong><?php echo $salat['isha']; ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
